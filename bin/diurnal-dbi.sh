...
JAVA_PARAM="-Xmx351m"
APP_PARAMS="-DSPRING_SECURITY_USERNAME=$PROM_SPRING_USER -DSPRING_SECURITY_CRED=$PROM_SPRING_CRED -DSPRING_PROFILE=local -DDBI_TABLES_CREATE_ONSTARTUP=true -DDBI_INACTIVE_TIMEOUT_SECONDS=300"
